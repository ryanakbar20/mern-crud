        ...
        return (
            <div className="card bordered" style={{padding: '60px 80px'}}>
                ...
                <h6 className="font-weight-light text-gray-500">
                    You will pay {" "} 
                    <span className="text-gray-900 font-weight-bold">${itemDetails.price * data.duration} USD</span>{" "}
                    per{" "}
                    <span className="text-gray-900 font-weight-bold">{data.duration} {itemDetails.unit}</span>
                </h6>
                <Button 
