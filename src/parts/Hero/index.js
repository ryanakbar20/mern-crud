        ...
        <section className="container pt-4">
            <div className="row align-items-center">
                <div className="col-auto pr-5" style={{width: 500}}>
                    ...
                    <p className="text-gray-500 mb-5 font-weight-light w-75" style={{lineHeight: '170%'}}>
                    We provide what you need to enjoy your
                    holiday with family. Time to make another
                    memoriable moments
                    </p>
                    <Button onClick={showMostPicked} className="btn px-5 " isPrimary hasShadow>Show Me Now</Button>
